...
async function NextAuthHandler(params) {
  var _req$body$callbackUrl, _req$body, _req$query, _req$body$registering, _req$body2, _req$query2, _req$body3;
  ...
  const {
    ...
    registering: (_req$body$registering = (_req$body2 = req.body) === null || _req$body2 === void 0 ? void 0 : _req$body2.registering) !== null && _req$body$registering !== void 0 ? _req$body$registering : (_req$query2 = req.query) === null || _req$query2 === void 0 ? void 0 : _req$query2.registering,
    csrfToken: (_req$body3 = req.body) === null || _req$body3 === void 0 ? void 0 : _req$body3.csrfToken,
    cookies: req.cookies,
    isPost: method === "POST"
  });
  ...
  if (method === "GET") {
    ...
    switch (action) {
      ...
      case "signin":
        if (pages.signIn) {
          let signinUrl = `${pages.signIn}${pages.signIn.includes("?") ? "&" : "?"}callbackUrl=${encodeURIComponent(options.callbackUrl)}&registering=${options.registering}`;
        ...
        if (userOptions.logger) {
          try {
            ...
            const {
              ...
              level,
              ...metadata
            } = (_req$body4 = req.body) !== null && _req$body4 !== void 0 ? _req$body4 : {};
