...
var _registering = require("./lib/registering");
...
async function init({
  ...
  const {
    registering,
    registeringCookie
  } = await (0, _registering.createRegistering)({
    options,
    cookieValue: reqCookies === null || reqCookies === void 0 ? void 0 : reqCookies[options.cookies.registering.name],
